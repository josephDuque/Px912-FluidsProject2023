...
! numeric volume flux:
volumeFlux_ana = (2.0_real64*G*(W**3))/(3.0_real64*nu)
...
open (9 , file = "channelFlow-transient.txt" , form = 'formatted')
...
!---------------------------------------------------------
open(unit=10, file='data2Plot-channelFlow.dat',status='unknown')
