...
real(real64), dimension ( n ) :: r ,b ,f , f_ana, integrand, absErr, relErr
...
do i = 2 ,n-1
  A(i, i-1) = 2.0_real64*r(i) - h
  A(i, i) = -4.0_real64*r(i)
  A(i, i+1) = 2.0_real64*r(i) + h
  b(i) = -(2.0_real64*(h**2)*G*r(i))/nu
end do
...
open (9 , file = "pipeFlow-stationary.txt" , form = 'formatted')
